...
import { prisma } from "../src/config/prisma"; // use the shared client, not a new one
...
export async function seedDatabase() {
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor1.id, name: "Nyama Choma (500g)" } },
    update: {},
    create: {
      vendorId: vendor1.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor1.id, name: "Ugali, Sukuma & Beef Stew" } },
    update: {},
    create: {
      vendorId: vendor1.id,
      categoryId: delicaciesCategory.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor1.id, name: "Githeri Special" } },
    update: {},
    create: {
      vendorId: vendor1.id,
      categoryId: delicaciesCategory.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor1.id, name: "Mukimo with Chicken Stew" } },
    update: {},
    create: {
      vendorId: vendor1.id,
      categoryId: delicaciesCategory.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor1.id, name: "Stoney Tangawizi (500ml)" } },
    update: {},
    create: {
      vendorId: vendor1.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor1.id, name: "Dawa (fresh ginger & lemon)" } },
    update: {},
    create: { vendorId: vendor1.id, categoryId: drinksCategory1.id, name: "Dawa (fresh ginger & lemon)", basePrice: 150, prepTimeMins: 5 },
  });
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor2.id, name: "Mandazi (3 pieces) & Chai" } },
    update: {},
    create: {
      vendorId: vendor2.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor2.id, name: "Uji wa Mtama" } },
    update: {},
    create: { vendorId: vendor2.id, categoryId: breakfastCategory.id, name: "Uji wa Mtama", description: "Warm fermented millet porridge.", basePrice: 80, prepTimeMins: 8 },
  });

  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor2.id, name: "Pilau with Beef" } },
    update: {},
    create: {
      vendorId: vendor2.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor2.id, name: "Swahili Fish Biryani" } },
    update: {},
    create: {
      vendorId: vendor2.id,
      categoryId: lunchCategory.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor2.id, name: "Quarter Kuku Choma" } },
    update: {},
    create: {
      vendorId: vendor2.id,
      categoryId: lunchCategory.id,
  ...
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor2.id, name: "Bhajia (serving)" } },
    update: {},
    create: { vendorId: vendor2.id, categoryId: snacksCategory.id, name: "Bhajia (serving)", basePrice: 150, prepTimeMins: 12 },
  });
  await prisma.foodItem.upsert({
    where: { vendorId_name: { vendorId: vendor2.id, name: "Beef Samosas (3 pieces)" } },
    update: {},
    create: { vendorId: vendor2.id, categoryId: snacksCategory.id, name: "Beef Samosas (3 pieces)", basePrice: 130, prepTimeMins: 10 },
  });
  ...
  const summary = {
    ...
    vendor1: "254700000002 / Vendor@12345 (Mama Njeri's Kitchen)",
    vendor2: "254700000003 / Vendor@12345 (Coastal Breeze Grill)",
    rider: "254700000004 / Rider@12345",
    customer: "254700000005 / Customer@123",
  };
...
// Only runs when this file is executed directly (e.g. `npx prisma db seed`),
// not when imported by the API route below.
